  ...
  return (
    <div className="text-white mt-32 w-10/12 mx-auto">
      <div className="text-center">
        ...
        <p>
          Gamers Bank is a Tournament App. You can find Free Fire tournaments, easily participate to the tournaments and get rewards. <br /> Register with two steps and participate to the tournaments.
        </p>
      </div>
